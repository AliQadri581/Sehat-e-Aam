...
//                             <div key={med._id} className="bg-gray-800 p-4 rounded-lg mb-4">
//                                 <h3 className="text-xl font-bold text-white">{med.medName}</h3>
//                                 <p className="text-sm text-gray-400">Grams: {med.medgrams}g</p>
//                                 <p className="text-sm text-gray-400">Price: ${med.medPrice}</p>
